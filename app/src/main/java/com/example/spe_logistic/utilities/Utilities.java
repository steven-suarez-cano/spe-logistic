...
public class Utilities {
    ...
    public static final void insertInventory(SQLiteDatabase db){
        ...
        calendar.add(Calendar.DATE,-60);
        String date90 = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(calendar.getTime());
        calendar.add(Calendar.DATE,-90);
        String date120 = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(calendar.getTime());
        ...
        db.execSQL("INSERT INTO referencias(nombre,valor,codigo_barras,unidades_empaque,cliente_id) values('Harina de lentejas x 500gr', 12128,'7707345200091',1,1);");
        ...
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso) values(1,1,'A-1-1','2019-10-28 14:00:00');");
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso) values(1,1,'A-1-1','2019-10-28 14:00:00');");
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso) values(1,1,'A-1-1','2019-10-28 14:00:00');");

/*
        Log.i("APP","date "+date);
        Log.i("APP","date30 "+date30);
        Log.i("APP","date60 "+date60);
*/
        ...
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso) values(1,1,'A-1-1','"+date+"');");
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso) values(1,1,'A-1-1','"+date+"');");
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso) values(1,1,'A-1-1','"+date+"');");//10
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso) values(1,1,'A-1-1','"+date+"');");
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso) values(1,1,'A-1-1','"+date+"');");
        ...
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso) values(1,1,'A-1-1','"+date30+"');");
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso) values(1,1,'A-1-1','"+date30+"');");
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso) values(1,1,'A-1-1','"+date30+"');");//20
        ...
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso) values(1,1,'A-1-1','"+date60+"');");
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso) values(1,1,'A-1-1','"+date60+"');");
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso) values(1,1,'A-1-1','"+date60+"');");//30
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso) values(1,1,'A-1-1','"+date120+"');");
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso) values(1,1,'A-1-1','"+date120+"');");
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso) values(1,1,'A-1-1','"+date120+"');");
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso) values(1,1,'A-1-1','"+date120+"');");
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso) values(1,1,'A-1-1','"+date120+"');");
        ...
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso) values(4,1,'A-1-1','"+date30+"');");
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso) values(4,1,'A-1-1','"+date30+"');");
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso) values(4,1,'A-1-1','"+date90+"');");
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso) values(4,1,'A-1-1','"+date90+"');");
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso) values(4,1,'A-1-1','"+date90+"');");
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso) values(4,1,'A-1-1','"+date90+"');");
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso) values(4,1,'A-1-1','"+date90+"');");
        ...
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso) values(5,1,'A-1-1','"+date+"');");
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso) values(5,1,'A-1-1','"+date+"');");
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso) values(5,1,'A-1-1','"+date90+"');");
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso) values(5,1,'A-1-1','"+date90+"');");
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso) values(5,1,'A-1-1','"+date90+"');");
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso) values(5,1,'A-1-1','"+date90+"');");
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso) values(5,1,'A-1-1','"+date90+"');");
        ...
        db.execSQL("INSERT INTO despachos(fecha,guia,peso,cajas) values('2019-04-28 16:00:00','99915415','5','3');");
        ...
        db.execSQL("INSERT INTO envios(nombre_destinatario,direccion_destinatario,ciudad_destinatario_id,telefono_destinatario,email_destinatario,factura," +
                "despacho_id,fecha_reservado,fecha_alistado,cliente_id,estado_id) values('Tyson Aguirre','Calle 12 66','1','3135588','tyl@gmail.com','5465454'," +
                "1,'2019-04-24 13:00:00','2019-04-25 14:30:00',1,4);");
        db.execSQL("INSERT INTO envios(nombre_destinatario,direccion_destinatario,ciudad_destinatario_id,telefono_destinatario,email_destinatario,factura," +
                "despacho_id,fecha_reservado,fecha_alistado,cliente_id,estado_id) values('Steven Suarez','Crra 34A','2','3207116','ssc@gmail.com','659323'," +
                "2,'2019-11-02 11:00:00','2019-11-02 15:30:00',1,4);");
        db.execSQL("INSERT INTO envios(nombre_destinatario,direccion_destinatario,ciudad_destinatario_id,telefono_destinatario,email_destinatario,factura," +
                "fecha_reservado,fecha_alistado,cliente_id,estado_id) values('Camilo Suarez','Calle 99','1','4555555','csc@gmail.com','963258542'," +
                "'2019-11-01 07:00:00','2019-11-01 08:45:00',1,4);");
        db.execSQL("INSERT INTO envios(nombre_destinatario,direccion_destinatario,ciudad_destinatario_id,telefono_destinatario,email_destinatario,factura," +
                "fecha_reservado,fecha_alistado,cliente_id,estado_id) values('Estefania Rodriguez','Calle 112 58Sur','2','32069563','estefa@gmail.com','04601991'," +
                "'2019-07-01 07:00:00','2019-07-01 08:45:00',1,3);");
        db.execSQL("INSERT INTO envios(nombre_destinatario,direccion_destinatario,ciudad_destinatario_id,telefono_destinatario,email_destinatario,factura," +
                "fecha_reservado,fecha_alistado,cliente_id,estado_id) values('Sonia Cano','Calle 39 93 03','3','2365896','sonia@outlook.com','0-010101'," +
                "'2019-08-01 07:00:00','2019-08-01 08:45:00',1,3);");
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso,envio_id) values(1,4,'A-1-1','"+date120+"',1);");
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso,envio_id) values(1,4,'A-1-1','"+date120+"',1);");
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso,envio_id) values(1,4,'A-1-1','"+date120+"',1);");
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso,envio_id) values(1,4,'A-1-1','"+date120+"',1);");
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso,envio_id) values(1,4,'A-1-1','"+date120+"',1);");
        ...
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso,envio_id) values(1,4,'A-1-1','"+date120+"',1);");
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso,envio_id) values(1,4,'A-1-1','"+date120+"',1);");
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso,envio_id) values(1,4,'A-1-1','"+date60+"',2);");
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso,envio_id) values(1,4,'A-1-1','"+date60+"',2);");
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso,envio_id) values(1,4,'A-1-1','"+date60+"',2);");
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso,envio_id) values(1,4,'A-1-1','"+date60+"',2);");
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso,envio_id) values(1,4,'A-1-1','"+date60+"',2);");
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso,envio_id) values(1,4,'A-1-1','"+date60+"',2);");
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso,envio_id) values(1,4,'A-1-1','"+date60+"',2);");
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso,envio_id) values(6,3,'A-1-1','"+date60+"',2);");
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso,envio_id) values(6,3,'A-1-1','"+date60+"',2);");
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso,envio_id) values(6,3,'A-1-1','"+date60+"',2);");
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso,envio_id) values(6,3,'A-1-1','"+date60+"',2);");
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso,envio_id) values(6,3,'A-1-1','"+date60+"',2);");
        ...
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso,envio_id) values(1,4,'A-1-1','"+date60+"',1);");
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso,envio_id) values(1,4,'A-1-1','"+date60+"',1);");
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso,envio_id) values(2,4,'A-1-1','"+date60+"',1);");
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso,envio_id) values(2,4,'A-1-1','"+date60+"',1);");
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso,envio_id) values(2,4,'A-1-1','"+date60+"',1);");
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso,envio_id) values(2,4,'A-1-1','"+date60+"',1);");
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso,envio_id) values(2,4,'A-1-1','"+date60+"',1);");
        ...
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso,envio_id) values(2,4,'A-1-1','"+date60+"',1);");
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso,envio_id) values(2,4,'A-1-1','"+date60+"',1);");
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso,envio_id) values(3,4,'A-1-1','"+date60+"',1);");
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso,envio_id) values(3,4,'A-1-1','"+date60+"',1);");
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso,envio_id) values(3,4,'A-1-1','"+date60+"',1);");
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso,envio_id) values(3,4,'A-1-1','"+date60+"',1);");
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso,envio_id) values(3,4,'A-1-1','"+date60+"',1);");
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso,envio_id) values(4,3,'A-1-1','"+date90+"',3);");
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso,envio_id) values(4,3,'A-1-1','"+date90+"',3);");
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso,envio_id) values(4,3,'A-1-1','"+date90+"',3);");
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso,envio_id) values(4,3,'A-1-1','"+date90+"',3);");
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso,envio_id) values(4,3,'A-1-1','"+date90+"',3);");
        ...
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso,envio_id) values(4,3,'A-1-1','"+date90+"',3);");
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso,envio_id) values(4,3,'A-1-1','"+date90+"',3);");
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso,envio_id) values(6,3,'A-1-1','"+date90+"',3);");
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso,envio_id) values(6,3,'A-1-1','"+date90+"',3);");
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso,envio_id) values(6,3,'A-1-1','"+date90+"',3);");
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso,envio_id) values(6,3,'A-1-1','"+date90+"',3);");
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso,envio_id) values(6,3,'A-1-1','"+date90+"',3);");
        ...
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso,envio_id) values(6,3,'A-1-1','"+date90+"',3);");
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso,envio_id) values(6,3,'A-1-1','"+date90+"',3);");
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso,envio_id) values(3,3,'A-1-1','"+date90+"',4);");
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso,envio_id) values(3,3,'A-1-1','"+date90+"',4);");
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso,envio_id) values(3,3,'A-1-1','"+date90+"',4);");
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso,envio_id) values(3,3,'A-1-1','"+date90+"',4);");
        db.execSQL("INSERT INTO inventario(referencia_id,estado_id,posicion,fecha_ingreso,envio_id) values(3,3,'A-1-1','"+date90+"',4);");
        ...
        db.execSQL("INSERT INTO recogidas(fecha,cliente_id,direccion,latitud,longitud,ciudad_id,cantidad_cajas,alto_caja,ancho_caja,largo_caja,peso,descripcion_contenido,valor_declarado,estado_id)" +
                " values('2019-06-11 14:00:00',1,'Avenida circunvalar 32A',6.54651651,-74.51561651,1,30,50,50,40,120,'Cajas pertenecientes a mercancía saliente del mes',990000,3);");
        db.execSQL("INSERT INTO recogidas(fecha,cliente_id,direccion,latitud,longitud,ciudad_id,cantidad_cajas,alto_caja,ancho_caja,largo_caja,peso,descripcion_contenido,valor_declarado,estado_id)" +
                " values('2019-09-26 07:30:00',1,'Carrera 66 32 88',6.51224851,-74.515126155,1,35,25,20,20,80,'Recogida cajas importadas del mes',1850000,2);");
    ...
    public static final String CLIENTES_CIUDAD_ID      = "ciudad_id";
    ...
    public static final String RECOGIDAS_LATITUD               = "latitud";
    public static final String RECOGIDAS_LONGITUD              = "longitud";
    public static final String RECOGIDAS_CIUDAD_ID             = "ciudad_id";
    ...
    public static final String CREATE_RECOGIDAS                = "CREATE TABLE "+RECOGIDAS+" ("+RECOGIDAS_ID+" INTEGER NOT NULL PRIMARY KEY, "+
                                                                                                ...
                                                                                                RECOGIDAS_LATITUD+" REAL, "+
                                                                                                RECOGIDAS_LONGITUD+" REAL, "+
                                                                                                RECOGIDAS_CIUDAD_ID+" INTEGER, "+
